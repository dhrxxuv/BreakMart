        ...
        {({ values, setFieldValue }) => (
          <Form className="space-y-4">
            <div>
              ...
              <Field name="SubCategory" type="text" className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2" />
            </div>
            <div>
            ...
            <div>
              ...
              <Field as="select" name="Parentcategory" className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
